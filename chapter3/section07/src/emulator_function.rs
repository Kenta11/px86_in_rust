...
impl Emulator {
    ...
    pub fn push32(&mut self, value: u32) {
        let address = self.get_register32(Register::ESP as i32) - 4;
        self.set_register32(Register::ESP as i32, address);
        self.set_memory32(address, value);
    }

    pub fn pop32(&mut self) -> u32 {
        let address = self.get_register32(Register::ESP as i32);
        let ret = self.get_memory32(address);
        self.set_register32(Register::ESP as i32, address + 4);
